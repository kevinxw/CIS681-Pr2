...
namespace Kevin.CIS681.Project.CodeAnalyzer.Parser.Grammar.CSharp {
    class Loader : ALoader {
        ...
        private static readonly  string[] _keywordsArr = _keywords.Split('|');
        ...
        private static readonly string[] _typesArr = _types.Split('|');
        ...
        private static readonly string[] _preprossorsArr = _preprossors.Split('|');
		...
		private const string _pairedBlockDelimiters = 
			...
			"|(|)"	// used in function call (with or without parameters)
			;
        private static readonly string[] _pairedTokenDelimitersArr = _pairedTokenDelimiters.Split('|');
        ...
        public Loader () {
            ...
            _attr.Add(TokenIntegrityDetector.PairedTokenDelimitersKey, _pairedTokenDelimiters.Split('|'));
